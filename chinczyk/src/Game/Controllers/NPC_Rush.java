...
public class NPC_Rush extends Controller{
    public NPC_Rush(String controllerName, int controllerTeam, Board boardRef){
        this.boardRef = boardRef;
        this.controllerTeam = controllerTeam;
        this.controllerName = controllerName;
    }

    //nadpisanie metody, 'npc rush' wybiera pionki najbliżej mety
    @Override
